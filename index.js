...
const displayStr = `
    A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames.toLocaleString("en-US")} ${totalGames === 1 ? "game" : "games"}.
    Currently, ${totalUnfundedGames.toLocaleString("en-US")} ${totalUnfundedGames === 1 ? "game remains" : "games remain"} unfunded.
    We need your help to fund ${totalUnfundedGames === 1 ? "this amazing game" : "these amazing games"}!
`
...
newEle.innerHTML = firstGame.name;
firstGameContainer.appendChild(newEle);

// do the same for the runner up item
const newEle2 = document.createElement("p");
newEle2.innerHTML = secondGame.name;
secondGameContainer.appendChild(newEle2);

//Customizations:
// search for a specific game using its name:
function searchGame() {
    deleteChildElements(gamesContainer);
